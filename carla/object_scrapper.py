...
class ClientSideBoundingBoxes(object):
    ...
    def get_bounding_boxes(vehicles, camera):
        ...
        # filter far away objects
        # bounding_boxes = [bb for bb in bounding_boxes if all(bb[:, 2] < 50)]
    ...
    def get_bounding_box(vehicle, camera):
        ...
        world_cords = ClientSideBoundingBoxes._vehicle_to_world(bb_cords, vehicle)
        
        cords_x_y_z = ClientSideBoundingBoxes._world_to_sensor(world_cords, camera)        
    ...
    def _create_bb_points(vehicle):
        ...
        try : 
            ...
            extent = vehicle.trigger_volume.extent
            print("traffic extent: ", extent)
        finally : 
    ...
    def _vehicle_to_world(cords, vehicle):
        ...
        try : 
            ...
            bb_transform = carla.Transform(vehicle.get_location())
    ...
    def _sensor_to_world(cords, sensor):
        """
        Transforms image coordinates to word.
        """
