...
class Controller : 
    ...
    def parse_events (self, client, world, clock) : 
        ...
        print("Delay in Frame = ", time.time() - decoded_data.get('time', 0))
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if self._is_quit_shortcut(event.key):
                    ...
                    self.world.record[0] = not self.world.record[0]
                    ...
                    current_index = self.world.camera_manager.index
    ...
    def _parse_vehicle_keys(self, keys , throttleCan , BrakeCan , steering_stm, milliseconds):
        ...
        self._steer_cache = steering_stm
