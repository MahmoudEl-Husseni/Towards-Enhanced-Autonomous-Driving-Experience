    ...
    try:
        ...
        with CarlaSyncMode(world.world, 
            ...
            while True:
                ...
                snapshot, img_raw, depth_raw, lidar_raw, imu_raw, gnss_raw = sync_mode.tick(timeout=2.0)
                ...
                #     os.makedirs(f"amp_batches/{batch_name}")
                #     np.save(f"amp_batches/{batch_name}/agents_vectors.npy", agents_vectors)
                #     np.save(f"amp_batches/{batch_name}/objects_vectors.npy", objects_vectors)
                #     np.save(f"amp_batches/{batch_name}/lanes_vectors.npy", lanes_vectors)
