...
class CameraManager(object):
    def __init__(self, parent_actor, hud, gamma_correction):
        ...
        from tools.demo import Detector
    ...
    def _parse_image(weak_self, image):
        ...
        if self.sensors[self.index][0].startswith('sensor.lidar'):
            ...
            # record array raw
            record_raw_f = False
            record_raw_path = '/main/Towards-Enhanced-Autonomous-Driving-Experience/AV/YOLOP/carla_out/raw'
            if record_raw_f:
                cv2.imwrite(f'{record_raw_path}/raw_{image.frame}.jpg', array)
            ...
            if yolop:  
                start_t = time.time()
                det, da_mask, ll_mask = self.yolop_detector.detect(array)
                print(f"YOLOP Single Frame processing time = {time.time() - start_t} sec")
                array = self.yolop_detector.save(array.copy(), det, da_mask, ll_mask, '/main/Towards-Enhanced-Autonomous-Driving-Experience/AV/YOLOP/carla_out')
            ...
            # Recording array with prediction
            record_pred_f = False
            record_pred_path = '/main/Towards-Enhanced-Autonomous-Driving-Experience/AV/YOLOP/carla_out/pred'
            if record_pred_f:
                cv2.imwrite(f'{record_pred_path}/pred_{image.frame}.jpg', array)
